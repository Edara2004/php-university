<footer class="bg-gray-800">
    <div class="mx-auto w-full max-w-screen-xl">
        <div class="grid grid-cols-2 gap-10 px-4 py-2 lg:py-2 md:grid-cols-4">
            <div>
            ...
            <div>
                ...
                <ul class="text-gray-500 dark:text-gray-400 font-medium">
                    <li class="mb-4">
                        <a href="https://discord.gg/wzZqUk38BU" class="hover:underline">Discord Server</a>
                    </li>
                    <li class="mb-4">
        ...
        <div class="px-4 py-6 bg-gray-900 dark:bg-gray-900 md:flex md:items-center md:justify-between">
            ...
            <div class="flex mt-4 sm:justify-center md:mt-0 space-x-5 rtl:space-x-reverse">
                ...
                <a href="https://discord.gg/wzZqUk38BU" class="text-gray-400 hover:text-gray-900 dark:hover:text-white">
                ...
                <a href="https://github.com/Edara2004/php-university" class="text-gray-400 hover:text-gray-900 dark:hover:text-white">
