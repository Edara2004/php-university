        ...
        <div>
            ...
            <div class="h-screen">
                ...
                <div class="flex justify-center place-items-center p-2 pr-4 pt-10 mb-70">
                    <div class="border border-white bg-white/80 shadow-xl/30 rounded-md w-100">
                            ...
                            <div class="mb-3">
                                <div class="mb-3 grid grid-cols-2">
                                    <div class="col-span-2">
                                        ...
                                        <input type="text" autocomplete="off" name="username" class="border border-gray-800 rounded-md ps-3 h-7 mr-5">
                                    </div>
                                </div>
