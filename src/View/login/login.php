            ...
            <div class="h-screen">
                ...
                <div class="text-center">
                    <div class="container-login">
                        <h1 class="text-type-writer text-transparent mt-5 text-3xl font-extrabold leading-tight text-gray-900 dark:text-white md:text-5xl lg:text-6xl">
                            <span class="animate-pulse text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">¡Bienvenidos!</span>
                        </h1>
                    </div>
                </div>
                ...
                <div class="flex justify-center place-items-center p-2 pr-4 pt-10 mb-70">
                    <div class="border bg-white/70 shadow-xl/90 rounded-md w-auto h-auto">
                        ...
                        <form action="../../Controllers/user.php" method="post">
                            <h1 class="text-type-writer text-center font-sans font-extrabold text-3xl md:text-4xl py-5 text-gray-700">Iniciar sesion</h1>

                            <div class="px-4 sm:px-6">
                                <div class="mb-4">
                                    <label for="userLogin" class="text-type-writer block text-gray-700 text-sm font-bold mb-2">Usuario</label>
                                ...
                                <div class="mb-6"> 
                                    <label for="password" class="text-type-writer block text-gray-700 text-sm font-bold mb-2">Contraseña</label>
                                ...
                                <div>
                                    <div class="text-center mb-3 text-type-writer">
